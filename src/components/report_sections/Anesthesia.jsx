      ...
      <table className="anesthesia">
        ...
        <tbody>
          <tr>
            ...
            <td>
              General Anesthesia/ <i>Anesthésie Générale</i>
            </td>
            <td class="special5">
              {data.dataValueSets.dataValues.map((dataValue) => (
                <span>
                  {dataValue.dataElement == "jxkvz59TzMg" &&
          ...
          <tr>
            ...
            <td>
              Regional Anesthesia/{" "}
              <i>Anesthésie Régionale (rachianesthésie,..)</i>
            </td>
            <td class="special5">
              {data.dataValueSets.dataValues.map((dataValue) => (
                <span>
                  {dataValue.dataElement == "cu1aMhd8SDe" &&
                  dataValue.categoryOptionCombo == "BNTdWBe0N1F"
                    ? dataValue.value
                    : ""}
                </span>
          ...
          <tr>
            ...
            <td>
              Local Anesthesia/ <i>Anesthésie Locale</i>
            </td>
            <td class="special5">
              {data.dataValueSets.dataValues.map((dataValue) => (
                <span>
                  {dataValue.dataElement == "s0g5vUyKfVS" &&
                  dataValue.categoryOptionCombo == "BNTdWBe0N1F"
                    ? dataValue.value
                    : ""}
                </span>
